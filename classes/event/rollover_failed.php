 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class rollover_failed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventrollover_failed', 'local_culrollover');
    }
    ...
    public function get_description() {
        return "Rollover failed entry {$this->objectid} - {$this->other['error']}";
    }
